                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-warning">
                            <h4 class="card-title text-white">Edit Guru PNS</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('guru-pns.update', $guru_pns->id) }}" method="POST">
                                @if (count($errors) > 0)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nip" name="nip" value="{{ $guru_pns->nip }}">
                                </div>
                                <div class="form-group">
                                ...
                                <a href="/guru-pns" class="btn btn-warning">Kembali</a>
